...
source <- sold_products[sold_products$customer_no_sold != store_id,]
...
# Plot the mean item price per month.
do_ts_plot(my_ts,
           title = 'Per Month Normalized Item Price Per Month for All Items')
...
my_plot.decomposed.ts(ts_decomposition,
                      title = 'Components of Per Month Normalized Item Price for All Items')
...
do_plot(trend_per_month,
        'All Item Adjusted Price Trends (minus Seasonality & Randomness)')
