...
# Plot the mean item price per month.
do_ts_plot(my_ts,
           title = 'Per Month Normalized Item Price Per Month for New Items')
...
my_plot.decomposed.ts(ts_decomposition,
                      title = 'Components of Per Month Normalized Item Price for New Items')
...
do_plot(trend_per_month,
        'New Item Adjusted Price Trends (minus Seasonality & Randomness)')
